...
const LampSection = () => {
  ...
  return (
    <div className="py-6 md:pb-0">
      <section className="flex flex-col md:flex-row w-full md:items-center">
        {/* النصوص */}
        <div className="text-[28px]  md:text-3xl lg:text-4xl container md:mx-auto px-4 flex flex-col justify-center text-start  md:max-w-md z-10 mt-6 md:mt-0">
