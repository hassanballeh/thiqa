...
<div className='bg-primary py-10 md:py-0'>
    <section className="container mx-auto grid grid-cols-1 md:grid-cols-2 place-items-center md:place-items-stretch w-full">
        {/* النصوص */}
        <div className="text-xl md:text-3xl flex-1 px-4 text-center md:text-start flex flex-col justify-center max-w-[462px]">
            <h2 className=" font-bold text-white leading-relaxed max-w-md">
                {selectedCountry === "UAE" ? t("home.62-heading1") : t("home.65-heading1")}
            </h2>
            <div className='text-xs md:text-[16px]'>
                <p className=" text-white font-light mt-4 leading-relaxed">
                {selectedCountry === "UAE" ? t("home.62-heading2") : t("home.65-heading2")}
            </p>
            </div>
            <div className="flex gap-4 mt-4 md:mt-10 mx-auto md:mx-0 items-center">
                <Link
                    href="/tutoring-plan#book-form"
                    className="bg-gold text-xs md:text-sm rounded-3xl px-4 font-semibold py-1.5 text-white hover:bg-gold"
                >
                ...
                <div className="relative flex items-center">
                    <Link
                        href="/under-develop"
                        className="text-xs md:text-sm rounded-3xl px-4 font-semibold py-1.5 border border-white text-white hover:text-white hover:bg-primary/60"
                    >
                ...
                <div className="flex gap-4 mt-6 mx-auto md:mx-0 justify-center">
                    <button
                        ...
                        className={`rounded-full px-8 py-1  text-white hover:text-white hover:bg-gold  ${
                            selectedCountry === "KSA" ? "bg-[#00448C]" : "bg-transparent border border-white"
                        }`}
                    >
                        {t("home.62-KSA")}
                    </button>
                    <button
                        ...
                        className={`rounded-full px-8 py-1 text-white hover:bg-gold ${
                            selectedCountry === "UAE" ? "bg-[#00448C]" : "bg-transparent border border-white"
                        }`}
                    >
                        {t("home.62-UAE")}
                    </button>
                        ...
                        {selectedCountry === "UAE" ? (
                            <>
                                <motion.div variants={pointVariants}>
                                    <LocationLabel top="72%" left="50%" label={t("home.UAE-1")} lineHeight={120} />
                                </motion.div>
                                <motion.div variants={pointVariants}>
                                    <LocationLabel top="30%" left="76%" label={t("home.UAE-2")} lineHeight={60} />
                                </motion.div>
                                <motion.div variants={pointVariants}>
                                    <LocationLabel top="20%" left="84%" label={t("home.UAE-3")} lineHeight={60} />
                                </motion.div>
                                <motion.div variants={pointVariants}>
                                    <LocationLabel top="55%" left="84%" label={t("home.UAE-4")}  lineHeight={60} />
                                </motion.div>
                            </>
                        ) : (
                            <>
                                <motion.div variants={pointVariants}>
                                    <LocationLabel top="52%" left="53%" label={t("home.KSA")}  lineHeight={145} />
                                </motion.div>
                            </>
                        )}
                    </motion.div>
