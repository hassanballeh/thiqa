...
<div className="flex-1 md:ps-20 text-center md:text-start flex flex-col justify-center  md:max-w-md">
    <div className="inline-block font-roboto text-xl md:text-3xl">
<h2 className=" font-bold text-primary leading-tight text-center md:text-start max-w-52 mx-auto md:mx-0 md:max-w-[400px]">
