...
<div className="pt-20 bg-white" >
  <h2 className=" text-3xl font-bold text-primary text-center mb-6">As Seen In</h2>
<div
  dir="rtl"
...
>
  {[
   ...
   <section className="max-w-6xl mx-auto mt-14 md:mt-32 grid grid-cols-1 md:grid-cols-2 w-full">
  <div className="flex flex-col justify-center  text-center md:text-start max-w-lg relative">
...
<div className="flex items-center gap-2 mt-4">
  <img src="/google-play-black.svg" alt="Play Store" className="w-48" />
  <img src="/app-store-black.svg" alt="App Store" className="w-48" />
</div>
    </div>
  </div>
...
<div className="relative" dir={i18n.language === "ar" ? "rtl" : "ltr"}>
  ...
  <div
    className={`hidden md:block absolute bottom-0 ${i18n.language === "ar" ? "" : "right-0"} z-0`}
    style={{
      backgroundImage: "url('/bg-blue.jpg')",
      backgroundRepeat: "no-repeat",
      backgroundSize: "contain",
      width: "600px",   // العرض كما هو
      height: "500px",  // 👈 زيادة الطول
    }}
  />
...
<img
  ...
  className={`
    relative z-10
    scale-150 h-auto w-[350px] md:w-[340px] lg:w-[600px]
    -translate-x-28 md:-translate-x-44 -translate-y-16  // 👈 إزاحة لليسار
    mx-auto
  `}
/>
  ...
  <img
    ...
    className={`hidden md:block absolute h-14 bottom-20 z-50 ${i18n.language === "ar" ? "right-44" : "left-44"}`}
  />
  <img
    src="/gif/istolat-unscreen.gif"
    className={`hidden md:block absolute h-14 -top-4 z-50 ${i18n.language === "ar" ? "left-48" : "right-48"}`}
  />
  <img
    src="/gif/istolat-unscreen.gif"
    className={`hidden md:block absolute h-14 top-8 z-50 ${i18n.language === "ar" ? "left-36" : "right-36"}`}
  />
</div>
