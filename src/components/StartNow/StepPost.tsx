    ...
    <div className="">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-12 mt-14">
        {pricingPlans.map((plan, idx) => (
          <div
            key={idx}
            className={`relative mx-auto text-center text-gray1  shadow rounded-xl border border-primary transition-all duration-300 ${
              idx === 1 ? "bg-[#EEF1F8] mx-2 scale-110 " : "max-w-sm"
            }`}
          >
              ...
              <div className="absolute -top-16 right-0 transform -translate-x-1/2 z-10">
                <div className="relative flex items-center justify-center">
                  {plan.secondaryBadgeIconLeft && (
                    <img
                      src={plan.secondaryBadgeIconLeft}
                      alt="Left Icon"
                      className="absolute -top-12 -left-8 w-10 h-10 md:w-16 md:h-16"
                    />
                  )}
                  <img
                    src={plan.badgeIcon}
                  ...
                  {plan.secondaryBadgeIconRight && (
                    <img
                      src={plan.secondaryBadgeIconRight}
                      alt="Right Icon"
                      className="absolute -top-12 -right-6 w-10 h-10 md:w-16 md:h-16"
                    />
                  )}
                </div>
              </div>
            ...
            <div className="p-5 flex flex-col items-center gap-4">
              ...
              <div className="grid grid-cols-2 gap-2 w-full">
                {plan.prices.map((price: Price, i: number) => (
                  <div
                    key={i}
                    className="rounded-lg border border-primary bg-white flex flex-col items-center overflow-hidden shadow-sm"
                  >
                    <div className="bg-subPrimary text-white w-full py-2 text-sm font-medium text-center">
                      {price.title}
                    </div>
