...
const NewCustomer: React.FC = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      if (data.wantedHours)
        formData.append("wantedHours", data.wantedHours.toString());
      ...
      if (data.classDuration)
        formData.append("classDuration", data.classDuration.toString());
      if (data.classesPerWeek)
        formData.append("classesPerWeek", data.classesPerWeek.toString());
      ...
      if (data.schoolReturning)
        formData.append("schoolReturning", data.schoolReturning.toString());
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <CustomField
          ...
          label="School Name"
          type="text"
          placeholder="Brighton College Dubai"
        ...
        <CustomField
          ...
          {...register("googleMapLink", {
            pattern: {
              value:
                /^(https?:\/\/)?(www\.)?(maps\.app\.goo\.gl|goo\.gl\/maps|google\.com\/maps)\/.+$/i,
        ...
        <CustomField
          required
          label="School Returning"
          type="time"
          placeholder="02:00"
          {...register("schoolReturning")}
        />
      </div>
