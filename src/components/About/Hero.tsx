...
<AnimatePresence mode="wait">
  ...
  >
    <img src="/double-qout.svg" alt="Quote" className="absolute -top-8 left-8 w-16 h-16" />
    ...
    <p className="text-[0.98rem] font-light leading-relaxed max-w-md">{testimonial.text}</p>

    <div className="flex items-center gap-3 mt-6">
      <div className="w-10 h-10 rounded-full bg-[#D9D9D9] flex items-center justify-center">
        <span className="text-primary font-bold">{testimonial.initial}</span>
      </div>
...
<section className="flex w-full gap-2 h-[520px]">
  <div className="flex-1 flex flex-col gap-2">
    <div className="flex-[2] rounded-3xl bg-[#D9D9D9]"></div>
    ...
    <div className="flex-[1] rounded-3xl text-white bg-primary flex flex-col items-start justify-center px-8 py-4">
      ...
      <p className="text-lg font-bold max-w-xs"> { t("about.1-number1-heading1")}</p>
      <p className="text-xs font-extralight max-w-48"> { t("about.1-number1-heading2")}</p>
    </div>
  </div>
  ...
  <div className="flex-1 flex flex-col gap-2">
    <div className="flex-[1] rounded-3xl text-white bg-gold flex flex-col  items-start justify-center px-8 py-4">
      ...
      <p className="text-lg font-bold max-w-xs"> { t("about.1-number2-heading1")}</p>
      <p className="text-xs font-extralight max-w-48"> { t("about.1-number2-heading2")}</p>
    </div>
