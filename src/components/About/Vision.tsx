...
<img src='/vector-vision.svg' className='w-44'/>     
  ...
  <p className="text-xs sm:text-sm md:text-base max-w-sm mt-3 text-gray1 font-light leading-relaxed mx-auto md:mx-0">
    {t("about.12-heading2")}
  </p>
</div>
...
<div className='flex flex-col'>
                <h3 className="text-xl font-bold text-primary font-roboto ">{item.title}</h3>

<p className="text-sm max-w-sm mt-3 text-gray1 font-light leading-relaxed">
            {item.desc}
          </p></div>          </div>
