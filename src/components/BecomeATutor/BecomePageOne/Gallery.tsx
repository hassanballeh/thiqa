    ...
    <div className="md:py-12 bg-white">
      <section className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 px-6 py-12">
        <div className="col-span-1 flex flex-col justify-center items-center">
          <div className="flex-1 lg:px-4 text-center md:text-start flex flex-col items-center md:items-start justify-center max-w-sm md:-mt-8">
            <h2 className="text-[28px] md:text-2xl lg:text-4xl font-bold text-primary leading-tight">
              {t("become.6-heading1")}{" "}
            </h2>
            <p className="text-sm md:text-[15px] md:leading-normal text-gray1 font-light mt-4 max-w-xs sm:max-w-sm">
              {t("become.6-heading2")}{" "}
            </p>
            <div className="flex flex-col gap-4 mt-4 mx-auto md:mx-0 items-start lg:translate-y-[10px]">
              <div className="flex gap-4 mx-auto md:mx-0 relative">
                ...
                <img
                  src="/arrow-lamp.svg"
                  alt="Arrow"
                  className={`hidden lg:block absolute animate-bounce bottom-2 -translate-y-1/2 w-10 h-10 
    ...
    >
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7"></path>
        ...
        <div className="md:col-span-2 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
          {/* الشبكة الصغيرة */}
          <div className="sm:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 row-span-2 sm:row-span-1 md:row-auto">
            {[
              ...
              >
                ...
                <span className="absolute top-4 sm:top-5 left-1 sm:left-3 lg:left-4 max-w-[100%] px-1 sm:px-0 lg:px-2 py-1 rounded-md text-white font-semibold text-sm lg:text-lg md:whitespace-pre-line z-10">
                  {item.text}
                </span>
              </div>
            ))}
          ...
          <div className="relative row-span-2 col-span-1 group overflow-hidden rounded-[30px] sm:rounded-[60px]">
            ...
            />
            <div className="absolute inset-0 bg-black/20 transition duration-300 group-hover:bg-black/50" />
            <span className="absolute top-4 sm:top-5 left-1 sm:left-3 lg:left-4 max-w-full px-1 sm:px-0 lg:px-2 py-1 rounded-md text-white font-semibold text-sm lg:text-lg whitespace-pre-line z-10">
              {t("become.6-feautre3")}
            </span>
          </div>
          ...
          <div className="relative col-span-2 group overflow-hidden rounded-[28px] sm:rounded-[48px]">
            ...
            />
            <div className="absolute inset-0 bg-black/20 transition duration-300 group-hover:bg-black/50" />
            <span className="absolute top-4 md:top-2 lg:top-4 sm:top-10 left-3 sm:left-6 px-2 py-1 rounded-md text-white font-semibold text-base sm:text-lg lg:text-xl z-10">
              {t("become.6-feautre4")}
            </span>
          </div>
        </div>
