  ...
  <section className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 px-6 py-12">
    ...
    <div className="md:col-span-1 flex flex-col justify-center items-center">
      <div className="text-white md:px-4 text-center md:text-start flex flex-col justify-center max-w-sm">
        ...
        <p className="text-[15px] font-light leading-relaxed mt-4 max-w-sm">
{t("become.17-heading2")}        </p>
        ...
        <div className="flex flex-col gap-4 mt-6 mx-auto md:mx-0 items-start">
          ...
          <Link
            href="/under-develop"
            className="flex items-center underline font-medium hover:text-blue-100 text-sm"
          >
        ...
        .map((step) => (
          ...
          >
            ...
            <div className="text-center md:text-left mt-2 md:mt-0">
              ...
              <p className="text-xs md:text-xs font-extralight text-white mt-2 md:mt-3 max-w-60">
