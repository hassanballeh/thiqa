...
const Rewards = () => {
  ...
  const items = [
    { img: "gift.png", title: t("become.37-number1-1"), desc: t("become.37-number1-2") },
    { img: "hand.png", title: t("become.37-number2-1"), desc: t("become.37-number2-2") },
    { img: "exchange.png", title: t("become.37-number3-1"), desc: t("become.37-number3-2") },
  ];
  return (
...
<div className='text-3xl md:text-4xl 2xl:text-5xl'>
  <h2 className="font-bold text-primary leading-snug ">
   {t("become.37-heading1-1")} <span className="relative inline-block">
