          ...
          <div className="flex flex-col gap-4 mt-6 mx-auto md:mx-0 items-start">
            <div className="relative w-fit mx-auto md:mx-0">
              <img
                ...
                className="absolute -bottom-8 -left-16 h-24"
              />
              <Link
                href="/form/tutor"
          ...
          <div className="flex flex-col gap-8">
            {[
              ...
              >
                ...
                {/* النص */}
                <div className="flex flex-col gap-[6px] transition-all duration-300 group-hover:translate-x-1 group-hover:text-primary">
                  <h3 className="text-base font-bold text-gray1">
                    {step.title}
                  </h3>
                  <p className="text-xs md:text-sm text-gray1 max-w-sm sm:max-w-[420px] group-hover:text-gray-800">
                    {step.desc}
                  </p>
                </div>
              </div>
