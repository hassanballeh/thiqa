        ...
        <div className="text-center mx-auto">
          <div className="inline-block relative max-w-80 md:max-w-xl mx-auto">
            ...
            <img
              src="/line-comp.svg"
              alt="line"
              className="hidden md:block w-60 max-w-lg mx-auto"
            />
            <img
              src="/line-comp2.svg"
              alt="line"
          ...
          {cards.map((card, idx) => (
            ...
            >
              ...
              <img
                src={card.icon}
                alt={`icon-${idx}`}
                className="w-12 mb-6 text-0056B1"
              />
              ...
              {card.texts.map((text, i) => (
                <div
                  key={i}
                  className="flex flex-col items-start gap-3 mt-3 w-full"
                >
                  <p className={`text-sm ${card.textColor}`}>{text}</p>

                  {card.starsMap[i] === "line" ? (
                    <div className="pt-[8px] h-[18px]">
