...
const Hero = () => {
  ...
  return (
    <div className="relative w-full">
      <div className="md:h-[80vh] 2xl:h-[55vh] px-4 hidden md:block">
...
<Link href="#our-cons" className="flex items-center text-primary underline font-medium hover:text-blue-800 text-sm">
    ...
    >
      ...
      <div className="bg-white h-auto md:h-[80vh] 2xl:h-[50vh]  "></div>

      <div id="our-cons" className="relative md:absolute md:-bottom-44 h-fit left-1/2 md:-translate-y-1/2 translate-x-[-50%] w-full md:w-[90%] 2xl:w-[1400px] md:bg-white rounded-3xl shadow-lg px-6 py-12 md:px-20 md:py-16 z-10 mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
          <div className="text-3xl md:text-5xl text-center md:text-start flex flex-col justify-start max-w-lg w-full">
            <h2 className="text-primary leading-tight">
              {t("academic.5-heading1-1")} <span className="relative inline-block font-extrabold">
