...
<div className="md:col-span-1 flex flex-col justify-center items-center px-4 md:px-0">
  <div className="text-white text-center md:text-start flex flex-col gap-4 justify-center ">
    <h2 className="text-2xl md:text-3xl font-semibold leading-relaxed">
      {t("shadow.26-heading1")}
    </h2>

    <p className="text-sm md:text-xs font-light leading-relaxed max-w-full md:max-w-72 mx-auto md:mx-0">
